...
# Simplify CPU configuration to remove vector enhancements
system.cpu.numIQEntries = 40       # Use default or reduce instruction queue size
system.cpu.numROBEntries = 128     # Use default reorder buffer size
